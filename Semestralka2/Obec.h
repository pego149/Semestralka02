...
class Obec : public Area
{
	...
	int aPocPlatHlasov2;
public:
	Obec(int pIdKraja, string pNazovKraja, int pIdOkresu, string pNazovOkresu, int pIdObce, string pNazovObce, int pPocZapVolicov, int pPocVydObalok, double pUcastVolicov,
	...
	string getNazov() override { return aNazovObce; }
	string getNazovKraja() { return aNazovKraja; }
	string getNazovOkresu() { return aNazovOkresu; }
	...
	int getId() override { return aIdObce; }
	~Obec();
};
